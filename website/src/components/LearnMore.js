      ...
      >
        <div className="learn-more-content-box">
          <div className="learn-more-heading-wrapper">
            <h2 className="learn-more-heading">Our Algorithm</h2>
          </div>
          ...
          <p className="learn-more-paragraph"><strong>Content Based Filtering</strong></p>
          ...
          <p className="learn-more-paragraph"><strong>Collaborative Filtering</strong></p>
          ...
          <p className="learn-more-paragraph"><strong>Data Source</strong></p>
